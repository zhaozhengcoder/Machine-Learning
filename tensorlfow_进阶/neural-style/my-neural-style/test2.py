...
def main():
  ...
  content_output = sess.run(net[CONTENT_LAYERS[0][0]])
  ...
  style_output = sess.run(net[STYLE_LAYERS[0][0]])

  print ("style_output : ",style_output)
  ...
  print ("noise content : ",sess.run(net['conv4_2']))
  
  #print ("cost_content ",type(cost_content))
  #print ("cost_total ",type(cost_total))
