...
def RNN(X, weights, biases):
    ...
    global flag
    if(flag==1):
        print ("finnal_state shape [0]:",final_state[0].shape)
        print ("finnal_state shape [1]:",final_state[1].shape)
        print ("len of the outputs : ",len(outputs))
        print ("outputs[-1] shape : ",outputs[-1].shape)
        print ("weights['out'] shape : ",weights['out'].shape)
