...
with tf.Session() as session:
    ...
    while step < training_iters:
        ...
        # training_data 就是从文本里面读入的数据，即一行单词 
        # training_data --> 
        """ 
            In [11]: training_data.shape  -- >  Out[11]: (204,)
            ...
            'danger', 'consists', 'in', 'the',   ... 
        """
        # symbols_in_keys  -->  [[65], [0], [1]]
        """
            In [17]: dictionary['ago']
            Out[17]: 65

            In [18]: dictionary[',']
            Out[18]: 0
            
            In [19]: dictionary['the']
            Out[19]: 1
        """
