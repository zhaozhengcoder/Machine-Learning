...
def show1_ticks(arr_true,arr_prediction):
    ...
    x_kedu=[21,22,23,0,1,2,3,4,5,6]
    orig_ticks = [i*20 for i in range(10)]   #原始的刻度是0~180
    new_ticks = x_kedu
...
if __name__ == "__main__":
    ...
    ##add
    dataset = split_day_night_time.split_time_nighttime(np.array(dataset))   #(20, 14, 300)
