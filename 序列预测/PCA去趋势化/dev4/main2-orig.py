...
if __name__ == "__main__":
    ...
    for i in range(1, max_epoch + 1):
        ...
        if i % iter_show ==0:
            ...
            print ("iter : ",i," ",sess.run(mse, feed_dict=feed_dict))
    ...
    res = cal_total(y_pre_test_real,y_raw_test)
    print ("mre : {}  mae : {} ".format(res[0],res[1]))
    plt.show()
...
iter :  200   0.010509711
iter :  400   0.009937746
iter :  600   0.0060227592
iter :  800   0.0039492873
iter :  1000   0.0021384654
iter :  1200   0.001811213
iter :  1400   0.001006571
iter :  1600   0.0012514931
iter :  1800   0.001393108
iter :  2000   0.0011019937
iter :  2200   0.00052479847
iter :  2400   0.00040955291
iter :  2600   0.0013613943
iter :  2800   0.0003486303
iter :  3000   0.00042065664
iter :  3200   0.00040850847
iter :  3400   9.988815e-05
iter :  3600   0.00037464625
iter :  3800   0.0003788526
iter :  4000   0.00033318406
iter :  4200   0.00014709648
iter :  4400   0.00012860916
iter :  4600   0.0005322352
iter :  4800   0.00018554568
iter :  5000   0.0002009018
mre, mae, rmse : (0.07303442240291756, 0.31643847639713246, 0.1443171882366452)
"""